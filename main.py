...
class ManagerConsoleWindow(QMainWindow):
    def __init__(self):
        ...
        # 🌟 핵심 아키텍처: 특정 탭에서 변경이 일어나면(Signal), 모든 탭의 데이터를 동기화
    ...
    def load_all_data(self):
        """모든 탭 컴포넌트의 load_data()를 일괄 실행하여 완벽한 데이터 동기화 유지"""
